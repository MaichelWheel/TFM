...
# ---------------------------------------------------- #
# This is a MIT-BIH database ECG signal PCA (Class R)
# ---------------------------------------------------- #
...
plt.show()
"""
# Chosen 3 components (95% of explained variance)
...
app.layout = html.Div(children=[
    html.H1(children='Graph ECG with Dash: Beats R'),
...
def update_graph(value, value2, value3):
    ...
    Result_Vector = mv + p1*pc[0] + p2*pc[1] + p3*pc[2]
